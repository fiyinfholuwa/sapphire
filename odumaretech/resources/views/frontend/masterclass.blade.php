...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>OdumareTech - Master Class</title>
...
<div class="page-wraper">
	...
	<div class="account-form">
		<div class="account-head" style="background-image:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIZmx1mK1ZjsVyIoV5XBggnGr2iQ5HHTs04g&usqp=CAU);">
			<!-- <a href="index.html"><img src="assets/images/synta_logo.png" alt=""></a> -->
		</div>
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
					<h2 class="title-head">Join Our  <span>Free Master Class</span></h2>
					<!-- <p>Login Your Account <a href="login.html">Click here</a></p> -->
				</div>	
				<form method="post" action="{{route('masterclass.add')}}" class="contact-bx">
					@csrf
					<div class="row placeani">
                        ...
                        <div class="col-lg-12">
							<div class="form-group">
								<div class="input-group">
									<label>Intrested Skill</label>
									<input name="intrested_in" type="text" required="" class="form-control">
								</div>
							</div>
						</div>
                        ...
                        <div class="col-lg-12">
							<div class="form-group">
								<div>
									<label>Level of Career</label>
									<select required name="career" class="form-control">
                                        <option  selected disabled>Select Level of Career</option>
						...
						<div class="col-lg-12 m-b30">
							<button name="submit" type="submit" value="Submit" class="btn button-md">Join the waiting list</button>
						</div>
