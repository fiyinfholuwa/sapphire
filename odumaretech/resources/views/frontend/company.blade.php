		...
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
					<h2 class="title-head">Corporate  <span>Training</span></h2>
					<!-- <p>Login Your Account <a href="login.html">Click here</a></p> -->
				</div>	
				<form method="post" action="{{route('corporate.training.add')}}" class="contact-bx">
					@csrf
					<div class="row placeani">
							...
							<div class="form-group">
								<div>
									...
									<select name="career" class="form-control">
                                        <option>Select Level of Training</option>
						...
						<div class="col-lg-12 m-b30">
							<button name="submit" type="submit" value="Submit" class="btn button-md">Submit Quota</button>
						</div>
