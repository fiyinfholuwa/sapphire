...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>OdumareTech - Join Our Team</title>
		...
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
					<h2 class="title-head">Join Our  <span>Team</span></h2>
					<!-- <p>Login Your Account <a href="login.html">Click here</a></p> -->
				</div>	
				<form method="post" action="{{route('instructor.add')}}" class="contact-bx" enctype="multipart/form-data">
					@csrf
					<div class="row placeani">
							...
							<div class="form-group">
								<div>
									...
									<select required name="career" class="form-control">
                                        <option value="" selected>Select Level of Career</option>
                        ...
                        <div class="col-lg-12">
							<div class="form-group">
								<div>
									<label>Choose from Available Courses</label>
									<select required name="course_ids[]" multiple id="langOpt">
                                    @if(count($courses) > 0)
						...
						<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group">
									...
									<input name="resume" type="file" accept=".pdf" required="" class="form-control">
								</div>
							</div>
						</div>
