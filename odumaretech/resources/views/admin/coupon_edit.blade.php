                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Edit Coupon Code</div>
                        </div>
                        <div class="card-body">
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$coupon->code}}" id="email2" required name="code" placeholder="Enter Coupon Code">
                                
                            </div>
                            <div class="form-group">
                                <label for="email2">Discount (%)</label>
                                <input type="number" class="form-control" value="{{$coupon->discount}}" id="email2" required name="discount" placeholder="Enter Discount"> 
                            </div>
                            <div class="form-group">
                                <label for="email2">Accessed Users</label>
                                <input type="number" class="form-control" value="{{$coupon->number}}" id="email2" required name="number" placeholder="Enter Accessed Users Number"> 
                            </div>
                            <div class="form-group">
