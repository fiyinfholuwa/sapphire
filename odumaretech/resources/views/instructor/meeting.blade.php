                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <div class="row">
                                ...
                                <input type="text" id="github" class="form-control" readonly id="email2" value="{{$meeting != null ? $meeting->link : 'No Meeting link provided yet'}}" required name="link" placeholder="Enter Meeting Link">
