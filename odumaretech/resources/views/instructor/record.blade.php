                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <div class="row">
                                ...
                                <input type="text" id="github" class="form-control" readonly id="email2" value="{{$record != null ? $record->link : 'No Recorded Session link provided yet'}}" required name="link" placeholder="Enter Recorded Session Link">
